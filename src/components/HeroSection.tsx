...
const HeroSection = () => {
  return (
    <section className="pt-20 pb-4 px-4 bg-background">
      <div className="container mx-auto max-w-md md:max-w-4xl">
        <div className="text-center mb-2 animate-fade-in">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight text-foreground mb-2 md:mb-3 px-2">
